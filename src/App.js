    ...
    <>
      ...
      <div className='intro bg-fixed overflow-hidden relative h-60 md:h-100'>
        ...
        <h1 className='text-gray-200 text-3xl ml-2 mt-6 m-auto md:text-3xl font-thin info md:mt-64 md:ml-40'>
          ...
          from <span className='font-bold text-white'>Mosul</span> that enjoys
          turning <span className='font-bold text-white'>numbers</span> and{' '}
          <span className='font-bold text-white'>letters</span> into live
          websites, If i'm not{' '}
          <span className='font-bold text-white'>coding</span> i'm either{' '}
          <span className='font-bold text-white'>drawing</span>,{' '}
          <span className='font-bold text-white'>soldering</span> or at the{' '}
      ...
      <div className='mywork bg-cover bg-fixed flex justify-evenly align-middles flex-col items-center h-auto md:h-120'>
        ...
        <div className='flex flex-col items-center space-y-8 md:flex-row md:space-y-0 justify-evenly w-full'>
          <a
            href='https://ibnmaher.github.io/Vanilla/'
            target='_blank'
            rel='noopener noreferrer'
          >
            <h1 className='text-4xl text-gray-300 font-extrabold text-center info'>
              Vanilla
            </h1>
            <div
            ...
            >
              ...
              {isShown === 1 && (
                ...
                >
                  <h1 className='p-3 info'>
                    Vanilla:{' '}
                    <span className='text-sm'>
                      is a vanilla HTML CSS JS and Bootstrap project it's a
                      restaurant website template where you can see the
                      restaurant menu, reviews and location and also for booking
                      a table
                    </span>
                  </h1>
                </motion.div>
          ...
          <a
            href='https://ibnmaher.github.io/Movies-hub/'
            target='_blank'
            rel='noopener noreferrer'
          >
            <h1 className='text-4xl text-gray-300 font-extrabold text-center info'>
              ...
              {isShown === 2 && (
                ...
                >
                  <h1 className='p-3 info'>
                    Movies hub:{' '}
                    <span className='text-sm'>
                      is a REACT, bootstrap project, it's a website where you
                      can see the latest popular movies releases or use the
                      search feature you can also view the rating release date
                      and trailer
                    </span>
                  </h1>
                </motion.div>
              ...
              {isShown === 3 && (
                ...
                >
                  <h1 className='p-3 info'>
                    Artisan:{' '}
                    <span className='text-sm'>
                      is a PERN-stack, (socket.io,tailwind,framer-motion)
                      project where you can either sign up as a user or artisan
                      to look for or offer a service
                    </span>
                  </h1>
                </motion.div>
              )}
      ...
      <footer className='h-32 bg-gray-900 flex flex-col'>
        ...
        <div className='text-gray-700 mt-12 m-auto'>Abdulrahman&#169;2022</div>
      </footer>
    </>
  )
}
